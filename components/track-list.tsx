      ...
      <div className="relative overflow-hidden">
        ...
        <div className="p-8">
          <div className="text-center">
            <h1 className="text-2xl font-bold mb-2 text-black">another receiptify</h1>
            <p className="text-xs text-black">Your Top Artists</p>
            <p className="text-xs text-gray-500 text-black">{today}</p>
          ...
          <div className="space-y-4">
            {tracks.map((track, index) => (
              ...
              >
                ...
                <p className="ml-4 whitespace-nowrap text-right text-black">
                  {track.popularity}%
                </p>
              </div>
            ))}
          ...
          <div className="text-center mt-8 text-xs">
            <p className="text-black">Thank you for listening!</p>
